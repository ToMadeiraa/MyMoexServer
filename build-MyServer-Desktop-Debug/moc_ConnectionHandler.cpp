...
QT_MOC_LITERAL(6, 59, 13) // "sendData_slot"

    },
    "ConnectionHandler\0finished\0\0process\0"
    "readyRead\0disconnected\0sendData_slot"
};
...
void ConnectionHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConnectionHandler::finished)) {
                *result = 0;
                return;
            }
        }
